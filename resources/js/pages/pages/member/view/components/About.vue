...
onMounted(() => {
  dataProperties.value = {
    about: [
      ...
      { property: 'Role', value: props.data.role, icon: 'tabler-star' },
      { property: 'Registered', value: props.data.registered, icon: 'tabler-user' },
    ],
    contacts: [
      { property: 'Contact', value: props.data.number, icon: 'tabler-phone' },
      { property: 'Email', value: props.data.email, icon: 'tabler-mail' },
    ],
    teams: [
  ...
  <VCard class="mb-4">
    <VCardText>
      ...
      <VList class="card-list text-medium-emphasis">
        <VListItem
          v-for="item in dataProperties['about']"
          :key="item.property"
        >
          <template #prepend>
            <VIcon
      ...
      <VList class="card-list text-medium-emphasis">
        <VListItem
          v-for="item in dataProperties['contacts']"
          :key="item.property"
        >
          <template #prepend>
            <VIcon
