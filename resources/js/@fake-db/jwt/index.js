...
//   const { verify, password } = JSON.parse(request.data)
//   let errors = {
//     verify: ['Something went wrong'],
//   }
//   const user = database.find(u => u.verify === verify && u.password === password)
//   if (user) {
//     try {
...
//   const { username, verify, password } = JSON.parse(request.data)
//
//   // If not any of data is missing return 400
//   if (!(username && verify && password))
//     return [400]
//   const isEmailAlreadyInUse = database.find(user => user.verify === verify)
...
//     verify: (() => {
//       if (!verify)
//         return ['Please enter your verify.']
//       if (isEmailAlreadyInUse)
//         return ['This verify is already in use.']
//
//       return null
//     })(),
//     username: (() => {
...
//   }
//
//   if (!errors.username && !errors.verify) {
//     // Calculate user id
//     const userData = {
//       id: genId(database),
//       verify,
