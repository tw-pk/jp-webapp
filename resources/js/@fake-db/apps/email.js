...
// GET: Return Emails
// ------------------------------------------------
mock.onGet('/apps/verify/emails').reply(config => {
...
// POST: Update Email
// ------------------------------------------------
mock.onPost('/apps/verify/update-emails/').reply(config => {
...
// ------------------------------------------------
mock.onPost('/apps/verify/update-emails-label').reply(config => {
...
// ------------------------------------------------
// mock.onGet('/apps/verify/paginate-verify').reply(config => {
