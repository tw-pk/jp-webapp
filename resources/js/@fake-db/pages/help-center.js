      ...
      subCategories: [
        {
          ...
          articles: [
            ...
            {
              slug: 'changing-your-primary-verify-address',
              title: 'Changing your primary verify address?',
              content: '<p>You can change the verify address associated with your personal account at any time from account settings.</p> <p><strong>Note:</strong> You cannot change your primary verify address to an verify that is already set to be your backup verify address.</p><p>You can change the verify address associated with your personal account at any time from account settings.</p> <p><strong>Note:</strong> You cannot change your primary verify address to an verify that is already set to be your backup verify address.</p>',
            },
            {
            ...
            },
            {
              ...
              content: '<p>Deleting your personal account removes data associated with your account.</p> <p>When you delete your account we stop billing you. The verify address associated with the account becomes available for use with a different account on website. After 90 days, the account name also becomes available to anyone else to use on a new account.</p><p>Deleting your personal account removes data associated with your account.</p> <p>When you delete your account we stop billing you. The verify address associated with the account becomes available for use with a different account on website. After 90 days, the account name also becomes available to anyone else to use on a new account.</p>',
            },
          ],
        },
        {
        ...
        },
        {
          ...
          articles: [
            ...
            {
              slug: 'how-to-set-billing-verify',
              title: 'How to set billing verify?',
              content: '<p>Your personal account\'s primary verify is where we send receipts and other billing-related communication.</p> <p>Your primary verify address is the first verify listed in your account verify settings. We also use your primary verify address as our billing verify address.</p> <p>If you\'d like to change your billing verify you can do it from account settings.</p><p>Your personal account\'s primary verify is where we send receipts and other billing-related communication.</p> <p>Your primary verify address is the first verify listed in your account verify settings. We also use your primary verify address as our billing verify address.</p> <p>If you\'d like to change your billing verify you can do it from account settings.</p>',
            },
          ],
        },
      ],
          ...
          articles: [
            {
              ...
              content: '<p>When you receive an online order, you\'ll receive a new order notification by verify.</p> <p>You\'ll be able to see that order on the orders page.</p><p>When you receive an online order, you\'ll receive a new order notification by verify.</p> <p>You\'ll be able to see that order on the orders page.</p>',
            },
            {
              slug: 'what-happens-when-you-process-an-order',
              title: 'What happens when you process an order?',
              content: '<p>When you process an order, The Orders page will show the order with a payment status of Paid or Partially paid.</p> <p>If the customer provided their verify address, then they receive a receipt by verify.</p><p>When you process an order, The Orders page will show the order with a payment status of Paid or Partially paid.</p> <p>If the customer provided their verify address, then they receive a receipt by verify.</p>',
            },
            {
        ...
        },
        {
          ...
          articles: [
            ...
            },
            {
              ...
              content: '<p>If you received an verify saying that your order is still processing, it means that your purchase is being screened by our third-party partner. All Payments orders are screened to ensure that the orders are legitimate and to protect from possible fraud.</p><p>Most orders are processed in under 72 hours. You\'ll receive a confirmation verify when the review is complete.</p><p>If you received an verify saying that your order is still processing, it means that your purchase is being screened by our third-party partner. All Payments orders are screened to ensure that the orders are legitimate and to protect from possible fraud.</p><p>Most orders are processed in under 72 hours. You\'ll receive a confirmation verify when the review is complete.</p>',
            },
          ],
        },
        {
    ...
    },
    {
      ...
      subCategories: [
        ...
        },
        {
          ...
          articles: [
            {
              slug: 'how-to-detect-fake-verify',
              title: 'How to detect fake verify?',
            ...
            {
              slug: 'someone-is-using-my-verify-address-what-can-i-do',
              title: 'Someone is using my verify address, what can I do?',
              content: '<p>Are you trying to create a new account, but you\'re told your verify address or phone number is already in use? This support article outlines how your verify address may already be in use and how to resolve the issue.</p><p>Are you trying to create a new account, but you\'re told your verify address or phone number is already in use? This support article outlines how your verify address may already be in use and how to resolve the issue.</p>',
            },
          ],
        },
      ],
    ...
    },
    {
      ...
      subCategories: [
          ...
          articles: [
            {
              ...
              content: '<p>You can send a message to your connections directly from the messaging page or connections page.</p><p>The sent message will be visible in the recipient\'s message list and possibly in their verify, depending on their app notification settings.</p><p>You can send a message to your connections directly from the messaging page or connections page.</p><p>The sent message will be visible in the recipient\'s message list and possibly in their verify, depending on their app notification settings.</p>',
            },
            {
        ...
        },
        {
          ...
          articles: [
            {
              slug: 'how-to-import-and-invite-your-verify-contacts',
              title: 'How to import and invite your verify contacts?',
              content: '<p>You can build your network by importing a list of your contacts you already know on the app. This will run a one-time upload of your address book contacts, as well as their detailed contact information. We periodically import and store details about your address book contacts to suggest relevant contacts for you to connect with, to show you relevant updates, and for other uses explained in our Privacy Policy. We\'ll never verify anyone without your permission.</p><p>You can build your network by importing a list of your contacts you already know on the app. This will run a one-time upload of your address book contacts, as well as their detailed contact information. We periodically import and store details about your address book contacts to suggest relevant contacts for you to connect with, to show you relevant updates, and for other uses explained in our Privacy Policy. We\'ll never verify anyone without your permission.</p>',
            },
            {
              slug: 'various-ways-to-connect-with-people',
              title: 'Various ways to connect with people?',
              content: '<p>Building your network is a great way to stay in touch with alumni, colleagues, and recruiters, as well as connect with new, professional opportunities. A primary verify address is mandatory to send invitations. Members become 1st-degree connections when they accept your invitation.</p><p>First-degree connections are given access to any information you\'ve displayed on your profile. To ensure an optimal site experience, the members can have a maximum of 30,000 1st-degree connections.</p><p>Building your network is a great way to stay in touch with alumni, colleagues, and recruiters, as well as connect with new, professional opportunities. A primary verify address is mandatory to send invitations. Members become 1st-degree connections when they accept your invitation.</p><p>First-degree connections are given access to any information you\'ve displayed on your profile. To ensure an optimal site experience, the members can have a maximum of 30,000 1st-degree connections.</p>',
            },
            {
