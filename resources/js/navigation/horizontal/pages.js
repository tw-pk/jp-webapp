      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            title: 'Verify Email',
            children: [
              { title: 'Verify Email v1', to: 'pages-authentication-verify-verify-v1', target: '_blank' },
              { title: 'Verify Email v2', to: 'pages-authentication-verify-verify-v2', target: '_blank' },
            ],
          },
          {
