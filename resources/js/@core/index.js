  ...
  return {
    themeConfig: {
      app: {
        ...
        teams_logo: userConfig.app.teams_logo,
...
export const defineDialerConfig = dialerConfig => {
    const localStorageDialerStatus = localStorage.getItem(`${themeConfig.app.title}-dialer`)

    return {
        dialerConfig: {
            dialer: {
                status: ref(localStorageDialerStatus || dialerConfig.dialer.status),
                iconRenderer: dialerConfig.dialer.iconRenderer,
            },
        },
    }
}
