...
export default defineComponent({
  ...
  setup(props, { slots }) {
    ...
    return () => {
      ...
      const verticalNav = h(VerticalNav, { isOverlayNavActive: isOverlayNavActive.value, toggleIsOverlayNavActive, navItems: props.navItems, credit: props.credit, ...additionalVerticalNavAttrs }, {
