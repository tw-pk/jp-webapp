...
return [
     ...
     */
    'jobs' => [
        'checkout_session_completed' => \App\Jobs\StripeWebhooks\CheckoutSucceededJob::class,
        'payment_intent_succeeded' => \App\Jobs\StripeWebhooks\PaymentIntentSucceededJob::class,
        //        'customer_subscription_created' => \App\Jobs\StripeWebhooks\SubscriptionCreatedJob::class,
